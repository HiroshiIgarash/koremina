  ...
  return (
    <div className="px-4 w-full max-w-4xl mx-auto">
      ...
      <h2 className="text-5xl md:text-6xl text-center leading-normal md:leading-relaxed">
        <FadeIn display="inline-block" margin="100px">
          コレミナは
        </FadeIn>
        <br />
        <FadeIn display="inline-block" margin="100px" delay={0.4}>
          <span className="text-[#2A4B71] font-bold">にじさんじ</span>の
        </FadeIn>
        ...
        <br />
        <FadeIn display="inline-block" margin="100px" delay={0.8}>
          共有できる
        </FadeIn>
        <br className="md:hidden" />
        <FadeIn display="inline-block" margin="100px" delay={1.2}>
          非公式
          <br className="md:hidden" />
          サービスです！
        </FadeIn>
          ...
          <FadeIn>
            <div>
              ...
              <p className="mt-4 text-center">
                右上のログインボタンから登録しよう！GoogleアカウントかXアカウントがあればOK！
                <span className="text-red-400">登録はすぐ終わるよ！</span>
              </p>
            </div>
          </FadeIn>
          <FadeIn>
      ...
      <section className="mt-20">
        ...
        <div className="mt-12 space-y-8 max-w-2xl mx-auto">
          <FadeIn>
            <div className="flex justify-center items-center gap-4">
              <div className="flex-1 p-4 md:py-8 border-4 border-green-400 rounded-2xl">
                <p className="text-xl md:text-center">
                  推しにはまった
                  <span className="text-red-400">きっかけの動画</span>
                </p>
              </div>
              <Image
                className="shrink-0"
          ...
          <FadeIn>
            <div className="flex justify-center items-center gap-4">
              <div className="flex-1 p-4 md:py-8 border-4 border-green-400 rounded-2xl">
                <p className="text-xl md:text-center">
                  大好きで
                  <span className="text-red-400">何回も見てしまう動画</span>
                </p>
              </div>
              <Image
                className="shrink-0"
          ...
          <FadeIn>
            <p className="text-right text-xl">などなど...！</p>
          </FadeIn>
        </div>
      </section>
