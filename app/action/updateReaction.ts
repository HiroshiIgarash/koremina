...
const updateReaction = async (reaction: Reaction, postId: string, active: boolean, currentUser: User) => {
  ...
  const updateData = Object.fromEntries([[reactionVideo, { set: newReactionVideoIds.map(i => ({ id: i })) }]])
